# GStack Strategy 21 GPT — Preview Test Prompts

Use these in the GPT Builder Preview pane before publishing.
...
- Produces a smallest useful version.
- Recommends `/strategy21` or `/build-brief` next.
...
- Produces a Ship/Narrow/Research/Kill verdict.
- Scores all 21 gates.
...
- Produces architecture, data flow, edge cases, dependencies, test plan, and rollback notes.
...
- Reviews primary flow plus empty/loading/error/permission states.
...
- Flags auth, SSRF/data access, abuse, missing tests, and auditability.
...
- Extracts lessons.
- Updates the strategy and QA loop.
